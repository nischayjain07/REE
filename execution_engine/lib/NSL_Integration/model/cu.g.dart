...
CU _$CUFromJson(Map<String, dynamic> json) {
  return CU(
    ...
    eventCUList: (json['eventCUList'] as List?)
        ?.map((e) =>  EventCU?.fromJson(e as Map<String, dynamic>))
        .toList(),
    ...
    exceptionCUList: (json['exceptionCUList'] as List?)
        ?.map((e) =>  ExceptionCU?.fromJson(e as Map<String, dynamic>))
        .toList(),
    mindCUList: (json['mindCUList'] as List?)
        ?.map((e) =>  MindCU?.fromJson(e as Map<String, dynamic>))
        .toList(),
    ...
    propertiesMap: json['propertiesMap'] == null ? null : PropertiesMap?.fromJson(json['propertiesMap'] as Map<String, dynamic>),
